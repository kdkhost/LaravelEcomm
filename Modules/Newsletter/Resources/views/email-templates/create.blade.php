...
@section('title','E-SHOP || Create Email Template')
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.email-templates.store')}}" method="POST" id="email-template-form">
                ...
                <div class="form-group">
                    ...
                    <div class="email-editor-container">
                        <div class="editor-toolbar">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertText('{{ $template->name }}')">
                                <i class="fas fa-user"></i> Name
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertText('{{ $template->email }}')">
                        ...
                        <textarea name="html_content" id="html_content" class="form-control" rows="15" required>{{ old('html_content', $template->html_content ?? '') }}</textarea>
                    </div>
                    @error('html_content')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea name="text_content" id="text_content" class="form-control" rows="8">{{ old('text_content', $template->text_content ?? '') }}</textarea>
                    @error('text_content')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="button-container">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save"></i> Economize Template
                    </button>
                </div>
            </form>
        </div>
