            ...
            <form action="{{route('admin.email-campaigns.store')}}" method="POST" id="campaign-form">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                ...
                                @foreach($templates as $template)
                                    <option value="{{ $template->id }}"
                                        ...
                                        @if($template->is_default)
                                            <span class="badge badge-warning">Padrao</span>
                                        @endif
                            ...
                            <small class="form-text text-muted">
                                Select the email template to use for this campaign. Padrao templates are pre-selected.
                            </small>
                            @error('template_id')
                ...
                <div class="button-container">
                    ...
                    <button type="button" class="btn btn-warning" onclick="saveDraft()">
                        <i class="fas fa-save"></i> Economize Draft
                    </button>
