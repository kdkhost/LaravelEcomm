                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route('posts.destroy', $post['id']) }}">
                                        ...
                                        <button class="btn btn-danger btn-sm dltBtn"
                                                ...
                                                data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                                    </form>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="9" class="text-center">No posts found! Please create a Post.</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
                @else
                    <h6 class="text-center">No posts found! Please create a Post.</h6>
                @endif
            </div>
        </div>
    </div>
